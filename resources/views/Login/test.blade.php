  ...
  select {
    ...
    <li class="nav-item dropdown">
      ...
      @if (Route::has('local.login'))
                 <div class="">
                 @auth('local')
                      <a href="{{ url('locals/Homepage') }}" class="dropdown-item ">Dashboard</a>
                    @else
    ...
    <li class="nav-item dropdown">
      ...
      @if (Route::has('admin.login'))
                    <div class="">
                        @auth('admin')
                            <a href="{{ url('/admin/AdminHomepage') }}" class="dropdown-item">Admin Dashboard</a>
                        @else
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Organizer
      </a>
      <div class="dropdown-menu">
      @if (Route::has('volunteer.login'))
                    <div class="">
                        @auth('volunteer')
                            <a href="{{ url('/event/Orgevent') }}" class="dropdown-item">Organizer Dashboard</a>
                        @else
                            <a href="{{ route('volunteer.login') }}" class="dropdown-item">Organizer Log in</a>
                            @if (Route::has('volunteer.register'))
                                <a href="{{ route('volunteer.register') }}" class="dropdown-item">Organizer Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
