	...
	<div class="col-sm-6 mb-2">
		<div class="card border-success">
          ...
          <div class="card-footer bg-transparent border-success">
            <a href="/event/{{$evt->id}}/Admindelete" class="btn btn-danger" onClick="return confirm('Confirm Delete?')">Delete</a>
            <a href="/display/{{$evt->id}}/Adminview" class="btn btn-info">Update</a>
            <a href="/status/{{$evt->id}}/change" class="btn btn-success">Approve</a>
...
@foreach($mydata4 as $evtapp)
	<div class="col-sm-6 mb-2">
		<div class="card border-success">
          ...
          <div class="card-footer bg-transparent border-success">
            <a href="/event/{{$evtapp->id}}/Admindelete" class="btn btn-danger" onClick="return confirm('Confirm Delete?')">Delete</a>
            <a href="/display/{{$evtapp->id}}/view" class="btn btn-info">Update</a>
