    ...
    <div class="col-sm-6 mb-2">
		<div class="card border-success">
          ...
          <div class="card-footer bg-transparent border-success">
            <a href="/support/{{$support ->id}}/Admindelete" class="btn btn-danger" onClick="return confirm('Confirm Delete?')">Delete</a>
            
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">
	                  <a style="color:black; text-decoration: none;" href="/supportedit/{{$support ->id}}/AdminviewDonates">Update</a>
	          </button>
          </div>
		</div>
    <br>
...
@foreach($mydata as $donation)
	<div class="col-sm-6 mb-2">
		<div class="card border-success">
          ...
          <div class="card-footer bg-transparent border-success">
            <a href="/donation/{{$donation ->id}}/Admindelete" class="btn btn-danger" onClick="return confirm('Confirm Delete?')">Delete</a>
            
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">
	                  <a style="color:black; text-decoration: none;" href="/admin/{{$donation ->id}}/AdminviewDonates">Update</a>
	          </button>
