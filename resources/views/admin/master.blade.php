...
.form_wrapper_splited {
  ...
  select {
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #c5d8a6;">
        ...
        <li class="nav-item ">
        <a class="nav-link" href="/admin/AdminHomepage">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
        <a class="nav-link"href="/admin/donate">Donation<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
        <a class="nav-link"href="/admin/req">Request<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
        <a class="nav-link" href="/admin/event">Event <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
        <a class="nav-link" href="/admin/hot">HotSpot<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
        <a class="nav-link" href="/admin/Profile">Manage<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
         <div class="mt-3 space-y-1">
                ...
                <form method="POST"  action="{{ route('admin.logout') }}" style="margin-top:20px">
                    @csrf
                    <x-responsive-nav-link :href="route('admin.logout')" style="    font-size:18px; color:gray;margin-right:9px;font-weight:bold;padding:20px 10px 25px;font-family:SoDO Sans;text-decoration:none"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link> </form>     </li>
			  </div>
