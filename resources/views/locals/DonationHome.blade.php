	...
	<div class="modal-dialog"  >
		...
		<form action="/donation/create" method="POST">
			...
			<div class="mb-3">
				...
				<input name="LocalsID" type="text" class="form-control" id="LocalsID" placeholder="Item Name" value="{{Auth::guard('local')->user()->id}}">
			</div>
			<div class="mb-3">
...
<div class="col-sm-6 mb-2">
    <div class="card border-success">
        ...
        <div class="card-footer bg-transparent border-success"><center><button type="button" class="btn btn-success"style="width: 10rem;"><a href="/donation/{{$donation->id}}/details" style="color: white;">View</a></button></center></div>
    </div>
</div>
@endforeach
