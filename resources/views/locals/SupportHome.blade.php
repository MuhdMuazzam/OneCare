				...
				<div class="modal-header">
					...
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					  ...
					  <form action="/support/create" method="POST">
							{{csrf_field()}}
							<div class="mb-3">
									<label for="LocalsID" class="form-label">ID :</label>
									<input name="LocalsID" type="text" class="form-control" id="LocalsID" value="{{Auth::guard('local')->user()->id}}" readonly>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									<label for="supportQuantity" class="form-label">Quantity Require:</label>
									<input name="supportQuantity" type="number" class="form-control" id="supportQuantity" placeholder="">
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
										...
										<input name="supportKod" type="text" class="form-control" id="supportKod" placeholder="Postcode">
								</div>
								<div class="mb-3">
			...
			<div class="row">
				...
				<div class="col-sm-6 mb-2">
					<div class="card border-success">
						...
						<div class="card-footer bg-transparent border-success"><center><button type="submit" class="btn btn-success"style="width: 10rem;"><a href="/support/{{$support->id}}/details" style="color: white;">View</a></button></center></div>
					</div>
				</div>
				@endforeach
