...
<div id="app">
   ...
   <nav>
<span class="h4 fw-bold" style="font-family:sans-serif;color:#00918f;text-align:center"><b>Local People | Login </b></span>
</nav>
    </div>  
    ...
    <x-auth-card style="background-color:lightgray">
      ...
      <h4 class="text-center font-weight-bold"style="font-family:sans-serif"> Welcome Back! </h4><br>
        ...
        <div class="d-flex justify-content-between align-items-center">
         ...
         <br>
          <div class="content-center align-items-center">
            <button class="btn btn-primary btn-lg" style="background-color:#00918f;border:1px #00918f;width:70%"
              style="padding-left: 2.5rem; padding-right: 2.5rem;">{{ __('Log in') }}</button>
              @if (Route::has('local.register'))
            <br><p class="small fw-bold mt-2 pt-1 mb-0"><a href="{{ route('local.register') }}" style="text-decoration:none;font-size:medium">{{ __('Create Account') }}</a>
                @endif
          </div>
                </div>
            </div>
