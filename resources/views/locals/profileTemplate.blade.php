  ...
  select {
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #c5d8a6;">
      ...
      <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown">
         <i class="bi bi-envelope-fill" style="font-size:20px"></i><span class="badge badge-danger" id="count">!</span></a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        @foreach($locals_data as $user)
                <a class="dropdown-item text-primary" href="/locals/Profile">NEW:{{$user->requestName}} requested {{$user->donationItem}}!</a>
