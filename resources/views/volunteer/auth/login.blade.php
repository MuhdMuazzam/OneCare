...
<div id="app">
   ...
   <nav>
<span class="h4 fw-bold" style="font-family:sans-serif;color:#00918f;text-align:center"><b>Organizer | Login </b></span>
</nav>
    </div>  
    <x-volunteer-guest-layout style="background-color:lightgray" >
    <x-auth-card style="background-color:lightgray">
      ...
      <h4 class="text-center font-weight-bold"style="font-family:sans-serif"> Welcome Back! </h4><br>
        <form method="POST" action="{{ route('volunteer.login') }}">
            ...
            <x-input class="form-control form-control-lg" describeby="emailHelp" type="email" id="form3Example3" name="DonorEmail" :value="old('volunteers_Email')" required autofocus />
        ...
        <div class="d-flex justify-content-between align-items-center">
         ...
         <br>
          <div class="content-center align-items-center">
            ...
            <br><p class="small fw-bold mt-2 pt-1 mb-0"><a href="{{ route('volunteer.register') }}" style="text-decoration:none;font-size:medium">{{ __('Create Account') }}</a>
                @endif
          </div>
                </div>
            </div>
